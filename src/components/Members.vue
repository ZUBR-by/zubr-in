  ...
  <div class="scene mil-mrgn-t-170px" v-if="data">
    ...
    <div class="flex-column flex-algn-itms-c pdng-t-40px">
      <a href="#" class="button primary pdng-l-40px pdng-r-40px">
        Загрузить еще 50 членов <span class="mil-notdisplay"> избирательных</span> комиссий из {{ data.pagination.aggregate.count }}
      </a>
    </div>
  </div>
</template>
