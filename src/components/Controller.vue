<template>
    ...
    <div class="scene mrgn-t-130px mil-mrgn-t-80px">
        <div class="">
          <div class="pdng-b-30px">
            <h1>Перечеркни референдум - <br>перечеркни беззаконие!</h1>
          </div>
          <button class="button primary large flex-row flex-algn-itms-c">
            ...
            <div class="section mrgn-l-10px">
              <svg class="zoom-1_2" width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <div class="flex-row mil-flex-wrap">
            <div class="section size-50 pdng-r-30px mil-size-100 mil-pdng-0 mil-pdng-b-30px">
                ...
                <p class="txt-size-18px pdng-t-20px txt-lh-1_3em">
                    ...
                    Наша цель — мониторинг электоральных кампаний в Беларуси, сбор и систематизация данных о нарушениях.
                </p>
            </div>
        ...
        <div class="flex-row mil-flex-wrap">
            <div class="section size-50 pdng-r-30px mil-size-100 mil-pdng-0 mil-pdng-b-30px">
                ...
                <p class="txt-size-18px pdng-t-20px txt-lh-1_3em">
                    ...
                    фальсификаций на выборах.<br>
                    Гражданского контроля за выборами и референдумами не было долгие годы.<br>
                    Именно вседозволенность позволила госмашине отточить механизмы фальсификаций.
                    Именно безнаказанность превратила систему в диктатуру, а потом — в режим, который включил безудержное насилие.<br>
        ...
        <div class="flex-row mil-flex-wrap">
            <div class="section size-50 pdng-r-30px mil-size-100 mil-pdng-0 mil-pdng-b-30px">
              ...
              <p class="txt-size-18px pdng-t-20px txt-lh-1_3em">
                ...
                инициативами «<a href="" class="txt-underline-inline">ZUBR</a>», «<a href="" class="txt-underline-inline">Голос</a>» и «<a href="" class="txt-underline-inline">Честные люди</a>», правозащитными и партийными организациями позволили доказать,
                что выборы были сфальсифицированы. И мировой опыт, и собственный опыт беларусов говорит,
                что любые преступления нельзя игнорировать. Их нужно фиксировать.
                Только активные действия граждан на всех этапах любых электоральных кампаний влияют на их исход.
              </p>
              <p>
                Мы готовы повторять это снова и снова до смены режима и восстановления закона.
              </p>
            </div>
            <div class="section size-50 mil-size-100 mil-pdng-0">
    ...
    <div class="scene pdng-t-5px">
        <div class="flex-row mil-flex-wrap">
            <div class="section size-100 pdng-r-30px mil-size-100 mil-pdng-0 mil-pdng-b-30px">
                ...
                <p class="txt-size-18px pdng-t-20px txt-lh-1_3em">
                    Учитывая сегодняшний немыслимый уровень репрессий, оценив все возможные риски,
                    мы предлагаем беларусам покрыть краткосрочным независимым наблюдением так называемый
                    «референдум» именно потому, что его проведение незаконно. Через наши <a href="#" class="txt-underline"> чат-бот в Телеграм</a>
        ...
        <div class="flex-row mil-flex-wrap">
            <div class="section size-50 pdng-r-30px mil-size-100 mil-pdng-0 mil-pdng-b-30px">
                ...
                <p class="txt-size-18px pdng-t-20px txt-lh-1_3em">
                    ...
                    Давайте вместе сделаем все, чтобы сломать этот якобы “народный плебисцит”
                </p>
            </div>
            <div class="section size-50 mil-size-100 mil-pdng-0">
