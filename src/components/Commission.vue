      ...
      <div class="flex-row">
        <div class="section size-50">
          ...
          <h2 class="txt-size-20px">
            Дом Правительства, правое крыло
          </h2>
          ...
          <div class="mrgn-t-40px">
            <p>
              Длинное описание комисии описывающее ее назначение, события, или еще какую-либо полезную
              информацию для граждан Республики Беларусь и международного сообщества.
            </p>
            <p>
              Длинное описание комисии описывающее ее назначение, события, или еще какую-либо полезную
              информацию для граждан Республики Беларусь и международного сообщества.
          ...
          <div class="mrgn-t-40px">
            <div class="infoblock">
              ...
              <div class="infoblock-value">г. Минск, улица Чкалова, 6</div>
            </div>
            <div class="infoblock">
              <div class="infoblock-name">Тип комиссии:</div>
              <div class="infoblock-value">Территориальная комиссия</div>
            </div>
            <div class="infoblock">
              <div class="infoblock-name">Код комиссии:</div>
              <div class="infoblock-value">00-000-0000</div>
            </div>
            <div class="infoblock">
    ...
    <div class="campaign-candidates-list">
      ...
      <div class="person-wrp flex-column flex-algn-itms-strch">
        ...
        <div class="person-info pdng-t-10px">
          ...
          <div class="txt-size-12px txt-medium mrgn-t-10px">
            Бухгалтер
          </div>
        </div>
      ...
      <div class="incident-unit cursor-pointer">
        ...
        <div class="border-l-1px border-r-1px border-color2 pdng-20px">
          <p class="txt-size-14px txt-color-3-1">
            1. меня допустили на участок для голосования в период с 10.00 - 12.00. Все остальное время я
            проводил на улице под окном. Подсчет голосов был затруднён, поскольку был большой наплыв людей,
            которые стоя в очереди закрывали собой урну. До 10.00, находясь на улице, я видел из окна 2 кабинки
            и считал людей по двум кабинкам ...
          </p>
            ...
            <div class="flex-row flex-algn-itms-c">
              <div class="section">
                <svg class="block" width="24" height="34" viewBox="0 0 24 34" fill="none"
                  ...
                  <defs>
                    <filter id="filter0_d" x="0" y="0" width="24" height="34"
