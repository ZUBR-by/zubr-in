<template>
  <header-view>
    <div class="header-subnav border-t-1px border-color2">
      <a class="section flex-algn-slf-strch flex-row flex-algn-itms-c pdng-l-30px pdng-r-30px txt-algn-c border-r-1px border-color2 hovered"
         href="#">
      ...
      <div class="section pdng-30px pdng-t-15px pdng-b-15px flex-grow-all">
        <div class="txt-color-1 txt-size-15px txt-bold">
          Вброшенный президент
        </div>
        <div class="txt-size-15px">
  ...
  <div class="scene">
    <div class="article-view" v-if="data">
      ...
      <div class="pdng-t-40px txt-size-18px" v-html="data.content.rendered">
      </div>
    </div>
  </div>
