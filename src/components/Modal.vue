        ...
        <div :ref="containerRef"
          ...
          <div class="popup-header flex-row flex-algn-itms-c border-b-1px border-color1">
            <div class="section flex-grow-all pdng-l-30px">
              <div class="txt-medium"><slot name="header"></slot></div>
            </div>
            <a class="close-popup cursor-pointer" @click="close"
                    :aria-label="ariaCloseLabel" type="button" tabindex="-1" v-ripple
            >
              <div class="pdng-t-15px pdng-b-15px pdng-r-20px pdng-l-20px">
                <svg class="block" width="21" height="21" viewBox="0 0 21 21" fill="none"
                     xmlns="http://www.w3.org/2000/svg">
                  <rect y="19.1013" width="26.8534" height="2.68534" transform="rotate(-45 0 19.1013)" fill="#FF5C01"/>
                  <rect x="1.89893" y="0.112793" width="26.8534" height="2.68534"
                        transform="rotate(45 1.89893 0.112793)"
                        fill="#FF5C01"/>
                </svg>
              </div>
            </a>
...
export default {
  ...
  methods: {
    ...
    enableDocumentSettings() {
      DomHandler.addClass(document.body, 'overflow-hide');
    },
    unbindDocumentState() {
      DomHandler.removeClass(document.body, 'overflow-hide');
    },
    onKeyDown(event) {
      if (event.which === 9) {
