          ...
          <div class="person-view mil-size-100">
            ...
            <div class="txt-size-12px">
              ...
              <div class="mrgn-t-10px">
                <a class="txt-underline-inline" @click="showModal = true">Это мой профиль. Почему я здесь?</a>
              </div>
            </div>
          </div>
        </div>
  ...
  <Dialog v-model:visible="showModal"
    ...
    <div class="scene">
      <p>Уважаемый(-ая) {{ data.member.full_name }}.
        ...
        общественный интерес. Если вы НЕ осуществляете деятельность в качестве участника электоральной компании по
        выборам, и
