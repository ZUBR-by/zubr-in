    ...
    <template v-if="data">
      <div class="committee-list mil-flex-column">
        ...
        <a class="committee-unit mil-flex-column" :href="'/commission/' + item.id" v-for="item of data.commissions">
          ...
          <div class="section pdng-r-20px pdng-l-20px pdng-t-20px pdng-b-20px border-l-1px border-color2 mil-border-0 mil-size-100 mil-pdng-15px mil-pdng-t-0 mil-border-b-1px mil-border-color1">
