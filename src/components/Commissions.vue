<template>
      ...
      <div class="section pdng-30px pdng-t-15px pdng-b-15px">
        <div class="inline-block">
          ...
          <div class="buttongroup">
            ...
            <button class="buttongroup-unit" :class="{active: view === 'map'}" @click="view = 'map'">
              Карта
            </button>
          </div>
        </div>
  ...
  <div style="margin-top:170px;" class="scene" v-if="view === 'list'">
    <div class="committee-list">
      <a class="committee-unit" href="commission.html">
          ...
          <div class="inline-flex flex-algn-itms-c">
            <div class="section">
              <div class="flex-row flex-algn-itms-c">
                <div class="section">
                  <svg class="block" width="16" height="21" viewBox="0 0 16 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1.66797 2.26288C1.66797 2.26288 4.16908 0.840252 5.84339 0.694131C8.02769 0.503502 9.8518 2.26288 11.355 2.26288C12.8581 2.26287 15.3634 1.21705 15.3634 1.21705V11.6753C15.3634 11.6753 13.6553 12.5125 12.5241 12.7212C9.90404 13.2044 8.51567 11.1524 5.84339 11.1524C3.17112 11.1524 1.66797 12.7212 1.66797 12.7212V2.26288Z" fill="#FF5C01"/>
      ...
      <a class="committee-unit mark" href="commission.html">
        <div class="section pdng-r-20px pdng-l-30px pdng-t-20px pdng-b-20px">
          <h2 class="txt-color-1 txt-size-20px txt-medium">
            Ленинский район г.Минска
          </h2>
          ...
          <div class="inline-flex flex-algn-itms-c">
            <div class="section">
              <div class="flex-row flex-algn-itms-c">
                ...
                <div class="section pdng-l-15px">
                  <div class=" txt-color-1 txt-size-20px txt-bold">
                    0
                  </div>
                </div>
              </div>
    ...
    <div class="map-wrp" style="background:#EDEDED; width:auto; min-height:640px">
      <div class="map-wrp-legend txt-size-14px">
        ...
        <div class="inline-flex flex-algn-itms-c txt-color-3-1 mrgn-l-20px">
          <div>
            <svg class="block" width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M1.51855 1.94125C1.51855 1.94125 3.79543 0.646169 5.31963 0.513148C7.30809 0.33961 8.96866 1.94125 10.3371 1.94125C11.7054 1.94125 13.9861 0.989181 13.9861 0.989181V10.5098C13.9861 10.5098 12.4312 11.272 11.4014 11.4619C9.01622 11.9018 7.75232 10.0338 5.31963 10.0338C2.88694 10.0338 1.51855 11.4619 1.51855 11.4619V1.94125Z" fill="#FF5C01"></path>
      ...
      <a class="map-mark" style="top:170px; left:160px;">
        <div class="section pdng-8px">
          <div class="flex-row flex-algn-itms-c">
            <div class="section">
              <svg class="block" width="22" height="14" viewBox="0 0 22 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M11 1.25C15.0486 1.25 17.6168 2.78517 19.1763 4.28975C19.9622 5.04792 20.4986 5.80548 20.8368 6.36991C20.9913 6.62764 21.1037 6.84396 21.1792 7C21.1037 7.15604 20.9913 7.37235 20.8368 7.63009C20.4986 8.19452 19.9622 8.95208 19.1763 9.71025C17.6168 11.2148 15.0486 12.75 11 12.75C6.95137 12.75 4.38316 11.2148 2.82367 9.71025C2.03783 8.95208 1.50143 8.19452 1.16317 7.63009C1.00871 7.37235 0.89626 7.15604 0.820791 7C0.89626 6.84396 1.00871 6.62764 1.16317 6.36991C1.50143 5.80548 2.03783 5.04792 2.82367 4.28975C4.38316 2.78517 6.95137 1.25 11 1.25ZM0.700307 6.73154C0.700114 6.73104 0.70007 6.73093 0.700174 6.7312L0.700307 6.73154Z" stroke="#FF5C01" stroke-width="1.5"/>
        ...
        <div class="section pdng-8px border-l-1px border-color2">
          <div class="flex-row flex-algn-itms-c">
            <div class="section">
              <svg class="block" width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.51855 1.94125C1.51855 1.94125 3.79543 0.646169 5.31963 0.513148C7.30809 0.33961 8.96866 1.94125 10.3371 1.94125C11.7054 1.94125 13.9861 0.989181 13.9861 0.989181V10.5098C13.9861 10.5098 12.4312 11.272 11.4014 11.4619C9.01622 11.9018 7.75232 10.0338 5.31963 10.0338C2.88694 10.0338 1.51855 11.4619 1.51855 11.4619V1.94125Z" fill="#FF5C01"/>
