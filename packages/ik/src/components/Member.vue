    ...
    <template v-if="data && data.member">
        ...
        <div class="scene">
            <div class="flex-row pdng-50px shadow-type-1 ik2022-radius-4px mil-flex-column-reserve">
                <div class="section size-50 mil-size-100">
                    ...
                    <a href="#" class="mrgn-t-5px blue-link txt-underline-inline">
                        Участок для голосования № 14: ГУО "Средняя школа №80 г.Минска"
                    </a>
                    <div class="uik-info-list mrgn-t-15px">
                        <div class="uik-info-unit" v-if="employer">
                            ...
                            <div class="uik-info-unit-value txt-size-14px txt-lh-1_5em">
                                <a class="blue-link txt-underline-inline"
                                   :href="'/organization/' + employer.organization.id">
                        ...
                        <div class="uik-info-unit">
                            ...
                            <div class="uik-info-unit-value txt-size-14px txt-lh-1_5em">
                                <a class="blue-link txt-underline-inline" href="#">ООО «Белорусская ассоциация
                                    врачей»</a>
                            </div>
                        </div>
                        <div class="uik-info-unit">
                            ...
                            <div class="uik-info-unit-value txt-size-14px txt-lh-1_5em">
                                <a class="blue-link txt-underline-inline" href="#">Октябрьский район г. Гомель</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="section size-50 mil-size-100">
                    <svg style="display:block; margin:0 auto;" width="287" height="380" viewBox="0 0 287 380"
                        ...
                        <path
                            d="M148.33 199.161C191.94 199.161 227.293 163.105 227.293 118.628C227.293 74.1513 191.94 38.0957 148.33 38.0957C104.72 38.0957 69.3672 74.1513 69.3672 118.628C69.3672 163.105 104.72 199.161 148.33 199.161Z"
                            fill="white"/>
                        <path
                            d="M215.858 131.684C215.858 170.96 183.938 202.806 144.553 202.806C105.169 202.806 73.248 170.96 73.248 131.684C73.248 92.4083 105.169 60.5625 144.553 60.5625C183.938 60.5625 215.858 92.4083 215.858 131.684Z"
                            stroke="#303030" stroke-width="3"/>
                        <path
                            d="M35.873 294.82C37.849 263.947 61.9563 202.201 142.577 202.201C223.198 202.201 249.94 263.947 253.233 294.82"
                            stroke="#303030" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                        <path
                            d="M4 2.12305H283V-1.87695H4V2.12305ZM285 4.12305V377.123H289V4.12305H285ZM283 379.123H4V383.123H283V379.123ZM2 377.123V4.12305H-2V377.123H2ZM4 379.123C2.89543 379.123 2 378.228 2 377.123H-2C-2 380.437 0.686297 383.123 4 383.123V379.123ZM285 377.123C285 378.228 284.105 379.123 283 379.123V383.123C286.314 383.123 289 380.437 289 377.123H285ZM283 2.12305C284.105 2.12305 285 3.01848 285 4.12305H289C289 0.809336 286.314 -1.87695 283 -1.87695V2.12305ZM4 -1.87695C0.686288 -1.87695 -2 0.809348 -2 4.12305H2C2 3.01848 2.89543 2.12305 4 2.12305V-1.87695Z"
                            fill="black"/>
                    </svg>
                </div>
            </div>
            <div class="flex-row pdng-50px shadow-type-1 ik2022-radius-4px mil-flex-column-reserve mrgn-t-40px">
                <div class="section size-50 mil-size-100">
                    <h1 class="txt-size-24px txt-color-2">
                        Участок голосования #14
                    </h1>
                    <p class="mrgn-t-5px">
                        ГУО "Средняя школа №10 г.Гомель"
                    </p>
                    <div class="uik-info-list mrgn-t-15px">
                        <div class="uik-info-unit">
                            <div class="uik-info-unit-name txt-size-14px txt-bold">
        ...
        <div class="scene">
            ...
            <div class="mrgn-t-20px mrgn-b-10px">
                <a class="txt-underline-inline" href="#">Вышестоящая комиссия</a>
            </div>
            <div class="uik-persons flex-row flex-wrap">
                <div class="uik-persons-unit-wrp size-33_3 pdng-15px mil-size-100">
                    <div class="uik-persons-unit pdng-15px shadow-type-1 ik2022-radius-4px">
        ...
        <div class="scene" style="background:#FF5959">
            ...
            <div class="white-box shadow-type-1 size-50 pdng-50px ik2022-radius-4px mil-size-100">
                ...
                <p class="txt-size-15px txt-lh-1_5em">
                    По опыту 2020 попасть в комиссии удается <b>только “опытным” участникам прошлых лет</b>.
                </p>
                <p class="txt-size-15px txt-lh-1_5em">
                    Это значит, что вам нужно составить идеальную заявку, но не стоит расстраиваться, если вам откажут.
                </p>
                <div class="pdng-t-30px">
                    <div class="flex-row flex-algn-itms-c pdng-t-10px pdng-b-10px border-t-1px border-color1">
                        <div class="section flex-grow-all txt-size-15px pdng-r-10px">
                            Бланк заявления
                        </div>
                        <div class="section flex-noshrink">
                            <a class="journal-2022-button black inline-flex flex-algn-itms-c" href="#">
                                <div class="section pdng-l-10px">
                                    Скачать
                                </div>
                                <div class="section pdng-l-10px pdng-r-5px">
                                    <svg style="margin:-5px 0" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path
                    ...
                    <div
                        class="flex-row flex-algn-itms-c pdng-t-10px pdng-b-10px border-t-1px border-b-1px border-color1">
                        <div class="section flex-grow-all txt-size-15px pdng-r-10px">
