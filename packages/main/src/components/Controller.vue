        ...
        <div class="flex-row mil-flex-wrap">
            <div class="section size-50 pdng-r-30px mil-size-100 mil-pdng-0 mil-pdng-b-30px">
                ...
                <p class="txt-size-18px pdng-t-20px txt-lh-1_3em">
                    ...
                    <br>
                    <i>Сам по себе референдум не позволяет выйти из кризиса – для этого нужны новые выборы.</i>
                </p>
            </div>
            <div class="section size-50 mil-size-100 mil-pdng-0">
        ...
        <div class="flex-row mil-flex-wrap">
            <div class="section size-50 pdng-r-30px mil-size-100 mil-pdng-0 mil-pdng-b-30px">
                ...
                <p class="txt-size-18px pdng-t-20px txt-lh-1_3em">
                    ...
                    организациями
                    позволили доказать, что выборы были сфальсифицированы. И мировой опыт, и собственный опыт
                    беларусов говорит, что любые преступления нельзя игнорировать.
                    Их нужно фиксировать.
                    Только активные действия граждан на всех этапах любых электоральных кампаний влияют на их исход.
                </p>
                <p>
                    Мы готовы <i>поддерживать такие действия</i> до смены режима и восстановления закона.
                </p>
            </div>
            <div class="section size-50 mil-size-100 mil-pdng-0">
        ...
        <div class="flex-row mil-flex-wrap">
            <div class="section size-100 pdng-r-30px mil-size-100 mil-pdng-0 mil-pdng-b-30px">
                ...
                <p class="txt-size-18px pdng-t-20px txt-lh-1_3em">
                    ...
                    «референдум» именно потому, что его проведение незаконно. Через наши <a href="#"
                                                                                            class="txt-underline">
                    чат-бот в Телеграм</a>
                    и онлайн-платформу ZUBR проведёт рекрутинг, <b>обучение, координацию активных граждан и
                    сбор информации о готовящемся “референдуме” и ходе кампании</b>.
                </p>
                <p>
                    <i>Любой избиратель Беларуси сможет полностью анонимно и
