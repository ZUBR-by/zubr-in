            ...
            <div class="section pdng-30px pdng-t-15px pdng-b-15px mil-pdng-20px mil-pdng-t-10px mil-pdng-b-10px">
                <div class="inline-block">
                    ...
                    <div class="buttongroup">
                        ...
                        <button class="buttongroup-unit" :class="{active: view === 'map'}"
                                @click="view = 'map';mapInit = true">
                            Карта
                        </button>
                    </div>
                </div>
    ...
    <div class="scene mrgn-t-170px mil-mrgn-t-170px" v-if="view === 'list'">
        <template v-if="data">
            <div class="committee-list mil-flex-column">
                <!--        :class="{mark: item === 2}"-->
                <a class="committee-unit mil-flex-column" :href="'/commission/' + item.id"
                   v-for="item of data.commissions">
                    <div
            ...
            <div class="flex-column flex-algn-itms-c pdng-t-40px" v-if="data.pagination.aggregate.count > 0">
                <button @click="offset = offset + 50" class="button primary pdng-l-40px pdng-r-40px"
                        v-if="data.pagination.aggregate.count > 50">
