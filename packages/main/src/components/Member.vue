            ...
            <div class="incident-unit cursor-pointer">
                ...
                <div
                    ...
                    <p class="txt-size-14px txt-color-3-1">
                        ...
                        проводил на
                        улице под окном. Подсчет голосов был затруднён, поскольку был большой наплыв людей, которые стоя
                        в очереди
                        закрывали собой урну. До 10.00, находясь на улице, я видел из окна 2 кабинки и считал людей по
                        двум кабинкам
                        ...
                    </p>
    ...
    <el-dialog v-model="showModal" :title="'Это мой профиль. Почему я здесь?'" :custom-class="'popup'"
        ...
        <div class="scene pdng-l-20px">
            <p>Уважаемый(-ая) {{ data.member.person.full_name }}.
                ...
                общественный интерес. Если вы НЕ осуществляете деятельность в качестве участника электоральной кампании
                по
                выборам, и
